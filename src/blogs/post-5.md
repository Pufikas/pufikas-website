...
![currently playing](https://pufikas.nekoweb.org/src/blogs/assets/b5/currplaying.png){.center .auto-margin .enlargeOnClick}
...
![scrobbler](https://pufikas.nekoweb.org/src/blogs/assets/b5/scrob.png){.width100 .enlargeOnClick}
the end result should look like this 
![scrobbres](https://pufikas.nekoweb.org/src/blogs/assets/b5/scrob2.png){.width50 .enlargeOnClick}
...
![netlify create project](https://pufikas.nekoweb.org/src/blogs/assets/b5/createproj.png){.width100 .enlargeOnClick}
...
![netlify select repo](https://pufikas.nekoweb.org/src/blogs/assets/b5/selectrepo.png){.width100 .enlargeOnClick}
...
![Netlify environment variables](https://pufikas.nekoweb.org/src/blogs/assets/b5/envvar.png){.width100 .enlargeOnClick}
...
![regex expression](https://pufikas.nekoweb.org/src/blogs/assets/b5/regexpression.png){.width100, .enlargeOnClick}
...
![origin](https://pufikas.nekoweb.org/src/blogs/assets/b5/originweb.png){.width100, .enlargeOnClick}
...
![file structure](https://pufikas.nekoweb.org/src/blogs/assets/b5/filestruct.png){.width100, .enlargeOnClick}
so go ahead and push to your repository and go back to Netlify and navigate to `Functions` tab
![netlify functions](https://pufikas.nekoweb.org/src/blogs/assets/b5/netfunc.png){.width100, .enlargeOnClick}
...
![endpoint netlify](https://pufikas.nekoweb.org/src/blogs/assets/b5/resnetlifylastfm.png){.width100, .enlargeOnClick}
